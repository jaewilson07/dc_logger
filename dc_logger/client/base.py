...
# %% auto 0
__all__ = ['OutputMode', 'ServiceConfig', 'ServiceHandler', 'HandlerInstance_BufferSettings', 'HandlerInstance', 'Logger']
...
@dataclass
class HandlerInstance_BufferSettings(ABC):
...
class HandlerInstance(ABC):
    ...
    buffer_settings: HandlerInstance_BufferSettings
