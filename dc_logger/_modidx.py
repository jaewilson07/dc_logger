  ...
  'syms': { 'dc_logger.client.Log': { 'dc_logger.client.Log.Correlation': ('client/log.html#correlation', 'dc_logger/client/Log.py'),
            ...
            'dc_logger.logs.services.cloud.datadog': { 'dc_logger.logs.services.cloud.datadog.DatadogHandler': ( 'logs/services/cloud/datadog.html#datadoghandler',
                                                       ...
                                                       'dc_logger.logs.services.cloud.datadog.DatadogHandler._validate_config': ( 'logs/services/cloud/datadog.html#datadoghandler._validate_config',
                                                                                                                                  'dc_logger/logs/services/cloud/datadog.py')},
            'dc_logger.logs.tracing': { 'dc_logger.logs.tracing.Correlation': ('client/log.html#correlation', 'dc_logger/logs/tracing.py'),
                                        'dc_logger.logs.tracing.Correlation.to_dict': ( 'client/log.html#correlation.to_dict',
                                                                                        'dc_logger/logs/tracing.py'),
                                        'dc_logger.logs.tracing.CorrelationManager': ( 'client/log.html#correlationmanager',
                                                                                       'dc_logger/logs/tracing.py'),
                                        'dc_logger.logs.tracing.CorrelationManager.__init__': ( 'client/log.html#correlationmanager.__init__',
                                                                                                'dc_logger/logs/tracing.py'),
                                        'dc_logger.logs.tracing.CorrelationManager.generate_request_id': ( 'client/log.html#correlationmanager.generate_request_id',
                                                                                                           'dc_logger/logs/tracing.py'),
                                        'dc_logger.logs.tracing.CorrelationManager.generate_session_id': ( 'client/log.html#correlationmanager.generate_session_id',
                                                                                                           'dc_logger/logs/tracing.py'),
                                        'dc_logger.logs.tracing.CorrelationManager.generate_span_id': ( 'client/log.html#correlationmanager.generate_span_id',
                                                                                                        'dc_logger/logs/tracing.py'),
                                        'dc_logger.logs.tracing.CorrelationManager.generate_trace_id': ( 'client/log.html#correlationmanager.generate_trace_id',
                                                                                                         'dc_logger/logs/tracing.py'),
                                        'dc_logger.logs.tracing.CorrelationManager.get_current_context': ( 'client/log.html#correlationmanager.get_current_context',
                                                                                                           'dc_logger/logs/tracing.py'),
                                        'dc_logger.logs.tracing.CorrelationManager.set_context_value': ( 'client/log.html#correlationmanager.set_context_value',
                                                                                                         'dc_logger/logs/tracing.py'),
                                        'dc_logger.logs.tracing.CorrelationManager.start_request': ( 'client/log.html#correlationmanager.start_request',
                                                                                                     'dc_logger/logs/tracing.py'),
                                        'dc_logger.logs.tracing.HTTPDetails': ('client/log.html#httpdetails', 'dc_logger/logs/tracing.py'),
                                        'dc_logger.logs.tracing.HTTPDetails.from_kwargs': ( 'client/log.html#httpdetails.from_kwargs',
                                                                                            'dc_logger/logs/tracing.py'),
                                        'dc_logger.logs.tracing.HTTPDetails.to_dict': ( 'client/log.html#httpdetails.to_dict',
                                                                                        'dc_logger/logs/tracing.py'),
                                        'dc_logger.logs.tracing.Log': ('client/log.html#log', 'dc_logger/logs/tracing.py'),
                                        'dc_logger.logs.tracing.Log._serialize_http_details': ( 'client/log.html#log._serialize_http_details',
                                                                                                'dc_logger/logs/tracing.py'),
                                        'dc_logger.logs.tracing.Log.create': ('client/log.html#log.create', 'dc_logger/logs/tracing.py'),
                                        'dc_logger.logs.tracing.Log.to_dict': ('client/log.html#log.to_dict', 'dc_logger/logs/tracing.py'),
                                        'dc_logger.logs.tracing.Log.to_json': ('client/log.html#log.to_json', 'dc_logger/logs/tracing.py'),
                                        'dc_logger.logs.tracing.LogEntity': ('client/log.html#logentity', 'dc_logger/logs/tracing.py'),
                                        'dc_logger.logs.tracing.LogEntity.from_any': ( 'client/log.html#logentity.from_any',
                                                                                       'dc_logger/logs/tracing.py'),
                                        'dc_logger.logs.tracing.LogEntity.get_info_from_parent': ( 'client/log.html#logentity.get_info_from_parent',
                                                                                                   'dc_logger/logs/tracing.py'),
                                        'dc_logger.logs.tracing.LogEntity.to_dict': ( 'client/log.html#logentity.to_dict',
                                                                                      'dc_logger/logs/tracing.py'),
                                        'dc_logger.logs.tracing.LogLevel': ('client/log.html#loglevel', 'dc_logger/logs/tracing.py'),
                                        'dc_logger.logs.tracing.LogLevel.from_string': ( 'client/log.html#loglevel.from_string',
                                                                                         'dc_logger/logs/tracing.py'),
                                        'dc_logger.logs.tracing.LogLevel.should_log': ( 'client/log.html#loglevel.should_log',
                                                                                        'dc_logger/logs/tracing.py'),
                                        'dc_logger.logs.tracing.MultiTenant': ('client/log.html#multitenant', 'dc_logger/logs/tracing.py'),
                                        'dc_logger.logs.tracing.MultiTenant.from_kwargs': ( 'client/log.html#multitenant.from_kwargs',
                                                                                            'dc_logger/logs/tracing.py'),
                                        'dc_logger.logs.tracing.MultiTenant.to_dict': ( 'client/log.html#multitenant.to_dict',
                                                                                        'dc_logger/logs/tracing.py')},
